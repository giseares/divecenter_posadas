...
#--- Activity--
owsd = Activity.create!( sort: "curso", start_date: "01/10/2020", duration: "10 dias", price: 450, name_activity: "OWSD - Open Water Scuba Diver", description: "El curso Open Water Scuba Diver SDI es un curso de introducción diseñado para proporcionar las habilidades necesarias para conducir con seguridad inmersiones en aguas abiertas. Algunas de las muchas habilidades que usted aprenderá incluyen la flotabilidad, un lastrado adecuado, la conservación marina, el montaje de equipos, una planificación del buceo adecuada, y un buen mantenimiento. El curso cubre todos los conocimientos básicos sobre la instalación, la fisiología y el medio ambiente marino, y también la formación de los estudiantes para llevar a cabo bajo el agua las habilidades básicas. Este curso es la clave para comenzar a explorar destinos de buceo de todo el mundo o sólo los de su patio trasero", location: "Posadas Buceo", agency_id: sdi.id)
awsd = Activity.create!( sort: "curso", start_date: "01/12/2020", duration: "5 dias", price: 400, name_activity: "AWSD - Advaance Scuba Diver", description: "El programa Advanced Diver SDI fue creado para hacer verdaderos buceadores avanzados. Durante el curso su instructor lo llevará a través de cuatro cursos completos de especialidad SDI, TDI, o ERDI (por ejemplo, profundo, navegación, fotografía, video, intro to tech, tender, etc) cubriendo los temas y las habilidades, de modo que al final se sientan cómodos para llevar a cabo inmersiones de esta naturaleza. Una vez que tenga bitacoradas 25 inmersiones (éstas pueden incluir cualquier y todas las inmersiones de entrenamiento), visite su centro de buceo local SDI con su bitácora y la verificación de haber completado cuatro especialidades de SDI, TDI y ERDI y usted sera otorgado con la certificación de Advanced Scuba Diver SDI.", location: "Posadas Buceo", agency_id: sdi.id)
...
ecare = Activity.create!( sort: "curso", start_date: "15/11/2020", duration: "7 dias", price: 250, name_activity: "Emergency Care", description: "Este curso incluye entrenamiento en reanimación cardiopulmonar (RCP), primeros auxilios y el uso de un desfibrilador externo automatizado (DEA) combinado en un solo programa.  Está diseñado para enseñar las técnicas para administrar RCP, primeros auxilios y utilizar un AED en situaciones de emergencia que involucran a bebés, niños y adultos.", location: "Posadas Buceo",  agency_id: fri.id)
